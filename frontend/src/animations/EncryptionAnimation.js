...
import { FaFile, FaLock, FaKey } from 'react-icons/fa';
...
const EncryptionAnimation = () => {
  useEffect(() => {
    // This would be for additional animation control if needed
  }, []);
  ...
  const particles = Array.from({ length: 15 }, (_, i) => {
    ...
    return (
      <ByteParticle
        ...
        animate={{ 
          x: [null, Math.random() * 300 + 200, Math.random() * 400 + 200],
  ...
  return (
    <AnimationContainer>
      ...
      <ProcessText>Encrypting your file...</ProcessText>
    </AnimationContainer>
  );
};
